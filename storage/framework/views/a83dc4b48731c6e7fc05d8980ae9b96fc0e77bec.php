...
<?php echo App\Http\Controllers\frontend\BlockController::banner(); ?>
...
<section class="Content">
    ...
    <div class="TopContent">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-18 col-xs-24 border-column">
                	<?php echo App\Http\Controllers\frontend\BlockController::posts_category_list(); ?>
