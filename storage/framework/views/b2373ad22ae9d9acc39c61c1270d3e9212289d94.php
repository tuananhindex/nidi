                    ...
                    <div id="dnn_ctr362_HtmlModule_lblContent" class="Normal">
                        <div class="FlexSlider">
                            ...
                            <?php foreach($banners as $val): ?>
                                <li class="clearfix" style="background: transparent url('<?php echo e(asset($val->image)); ?>') no-repeat; background-size:100% 100%">
                                    <!-- <div class="container">
                                        <div class="row">
                                ...
                                <div class="row">
                                    <style type="text/css">
                                        .product-home-tab .nav-tabs > li{
                                            width: <?php echo e(100 / count($product_category)); ?>% !important;
                                        }
                                    </style>
                                    <ul class="nav nav-tabs responsive" id="myTab">
                                    <?php foreach($product_category as $key => $val): ?>
                                        <li <?php if($key == 0): ?> class='active' <?php endif; ?>><a href='#tab<?php echo e($key); ?>'><?php echo e(ucwords($val->name)); ?></a></li>
                                    <?php endforeach; ?>
                                    ...
                                    ?>
                                        <div class="tab-pane <?php if($key == 0): ?> active <?php endif; ?>" id="tab<?php echo e($key); ?>">
                                            <div id="slider_container<?php echo e($key); ?>" style="position: relative; top: 0px; left: 0px; width: 1170px; height: 255px; overflow: hidden;" class="slider-container">
                                                ...
                                                <?php foreach($products as $key2 => $val2): ?>
                                                    <div>
                                                        <div  class="row">
                                                            <div class="col-md-8">
                                                                <div class="product-image">
                                                                    <a href="san-pham/plid/2/Phan-mem-quan-tri-doanh-nghiep-hop-nhat_3.htm"> <img src="<?php echo e(asset($val2->image)); ?>" alt="<?php echo e(ucwords($val2->name)); ?>" class="img-responsive" /></a>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-16">
                                                                <h2 class="product-title"><a href="javascript:void(0)"><?php echo e(ucwords($val2->name)); ?></a></h2>
