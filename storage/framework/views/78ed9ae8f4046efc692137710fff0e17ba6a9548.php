...
<link href="<?php echo e(asset('assets/frontend/css/NewsByCategory.css')); ?>" type="text/css" rel="stylesheet" />
<link href="<?php echo e(asset('assets/frontend/css/Telerik.Web.UI.WebResource.axd.css')); ?>" type="text/css" rel="stylesheet" />
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                    $key = preg_quote($key);
                ?>
                	<?php echo preg_replace("/($key)/i","<strong style='color:#f00 !important'>$1</strong>",App\Http\Controllers\frontend\BlockController::search($key)); ?>


                </div>
                <div class="col-md-6">
                    <div id="dnn_RowTwo3" class="ContentPadding">
                    	<?php echo App\Http\Controllers\frontend\BlockController::customer_reviews(); ?>

                        <?php echo App\Http\Controllers\frontend\BlockController::customer_support(); ?>
