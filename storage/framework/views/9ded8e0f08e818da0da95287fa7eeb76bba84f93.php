					...
					<div class="box-body">
						...
						<div class="form-group">
						  	...
						  	<select class="form-control cursor" name="cursor">
						  		...
						  		<option value="posts.category" <?php if($index->cursor == 'posts_category'): ?> selected <?php endif; ?>>Danh mục bài viết</option>
						...
						<div class="form-group">
							<label>Hiển thị ở menu top</label>
							<select class="form-control" name="menu_top">
								<?php if($index->menu_top == 1): ?>
