		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
				  	...
				  	<a href="<?php echo route($e['frontend_route'],$index->alias) ?>" target="_blank" class="btn btn-warning pull-right" style="margin-right:5px"><i class="fa fa-eye"></i> Xem bài viết</a>
				</div><!-- /.box-header -->
				<!-- form start -->
				<form method="post" enctype="multipart/form-data">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label>Hiển thị ở menu tin tức footer</label>
							<select class="form-control" name="pos_footer">
								<?php if($index->pos_footer == 1): ?>
								<option value="1">Có</option>
								<option value="0">Không</option>
								<?php else: ?>
								<option value="0">Không</option>
