                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo e(asset('images/dev.jpg')); ?>" class="user-image" alt="User Image">
                            <span class="hidden-xs">Tuan Anh Index</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="<?php echo e(asset('images/dev.jpg')); ?>" class="img-circle" alt="User Image">
                                <p>
                                    Tuan Anh Index - Web Developer
