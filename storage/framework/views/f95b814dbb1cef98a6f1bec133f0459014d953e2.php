...
<!-- Get FullBreadcum -->
	...
	<li><a href="<?php echo e(route('product_category',$category->alias)); ?>"><?php echo e(ucfirst($category->name)); ?></a></li>
 

<!-- End Get FullBreadcum --> 
			<li class="active"><a href="<?php echo e(route('product',$index->alias)); ?>"><?php echo e(ucfirst($index->name)); ?></a></li>
...
============================================= -->
									<div class="product-image product-main-image">
										<img src="<?php echo e(asset($index->image)); ?>">
...
<div id="pd_recentview" class="widget clearfix">
	...
	<div class="slick-slide"-->
		<div class="widget-last-view sl-slider col-xs-12" >
			<?php if($product_same): ?>
			<?php foreach($product_same as $val): ?>
			<div class="product_viewed col-xs-6 col-sm-4 col-md-3">
				<div class="product style_1 clearfix">
					<div class="product-image ">
						<a href="<?php echo e(route('product',$val->alias)); ?>"><img src="<?php echo e(asset($val->image)); ?>" alt="#"></a>
						<!-- <div class="sale-flash"></div> -->
					</div>
					<div class="product-desc">
						<div class="product-title">
							<a href="<?php echo e(route('product',$val->alias)); ?>"><?php echo e(ucfirst($val->name)); ?></a>
						</div>
						<div class="product-price">
							<ins> <?php echo e(number_format($val->price)); ?>đ </ins>
							<del></del>
						</div>
					</div>
				</div>
...
<div id="pd_recentview" class="widget clearfix">
	...
	<div class="slick-slide"-->
		<div class="widget-last-view col-xs-12 sl-slider">
			<?php if($product_same): ?>
			<?php foreach($product_other as $val): ?>
			<div class="product_viewed col-xs-6 col-sm-4 col-md-3">
				<div class="product style_1 clearfix">
					<div class="product-image ">
						<a href="<?php echo e(route('product',$val->alias)); ?>"><img src="<?php echo e(asset($val->image)); ?>" alt="#"></a>
