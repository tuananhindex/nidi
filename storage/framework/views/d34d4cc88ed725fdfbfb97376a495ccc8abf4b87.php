            ...
            <div id="dnn_ctr446_ModuleContent" class="DNNModuleContent ModMISACMSC">
                ...
                <div class="head-seperator">
                    <h1 class="news-category-title">
                        <span id="dnn_ctr446_ListNewsByCategory_lblTitle"><?php echo e(ucfirst($index->name)); ?></span>
                    </h1>
                </div>
                    ...
                    <div class="row">
                        <div class="newsbycategory">
                            <div class="col-md-9">
                                ...
                                <img src="<?php echo e(asset($val->image)); ?>" id="dnn_ctr446_ListNewsByCategory_radListNewsByCategory_ctrl0_Img1" class="img-subject img-responsive" alt="<?php echo e(ucfirst($val->name)); ?>" />
                                </a>
                            </div>
                            <div class="col-md-15">
                                <h2 class="nbc_title">
