 ...
 <a href="http://vesinhthanhpho.vn/bai-viet/gioi-thieu-ve-rut-ham-cau-trung-son" title="rut ham cau, dich vu rut ham cau, ham cau, rút hầm cầu, hầm cầu vesinhthanhpho.vn" rel="dofollow">rút hầm cầu</a>
	...
	<div class="LogoRow">
		<div class="container">
			...
			<div class="MobileNav">
				...
				<div id="dnnMobileMenu">
					<ul class="mobileTopLevel">
						<li class="itemMobile">
							<a href="<?php echo e(route('home')); ?>"><span>Trang chủ</span></a>
						</li>
						<?php if(isset($menus)): ?>
			...
			<nav class="Nav">
				<img style="float: left; margin: 26px 63px" class="col-xs-12" src="<?php echo e(asset('assets/frontend/img/nidi.png')); ?>">
