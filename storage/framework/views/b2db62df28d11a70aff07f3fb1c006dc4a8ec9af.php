...
<link href="<?php echo e(asset('assets/frontend/css/Testimonial.css')); ?>" type="text/css" rel="stylesheet" />
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-18 border-column">
                	<?php echo App\Http\Controllers\frontend\BlockController::customer_reviews_page(); ?>
