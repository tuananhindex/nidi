...
<link href="<?php echo e(asset('assets/frontend/css/AwardDetail.css')); ?>" type="text/css" rel="stylesheet" />
<?php if(file_exists($index->image)): ?>
            ...
            <div id="dnn_ctr570_ContentPane">
                ...
                <div id="dnn_ctr570_ModuleContent" class="DNNModuleContent ModDNNHTMLC">
                    <div id="dnn_ctr570_HtmlModule_lblContent" class="Normal">
                        <img alt="Giải thưởng MISA" style="width:100%; height:281px" src="<?php echo e(asset($index->image)); ?>" class="img-responsive">
                    </div>
                </div>
                <!-- End_Module_570 -->
            </div>
