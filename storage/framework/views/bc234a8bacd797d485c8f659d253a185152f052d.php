<div class="sidebar nobottommargin col_last clearfix hidden-xs col-md-3 col-sm-12">
	<div class="sidebar-widgets-wrap">
		...
		?>
		<?php if($posts_category_max): ?>
		<div class="widget widget_links clearfix">
			<h4>Danh mục</h4>
			<ul class="sidebar_menu">
				
				<?php foreach($posts_category_max as $val): ?>
			...
			<div class="tab-container sidebar_menu">
				...
				<div class="spost clearfix">
					<div class="entry-image">
							...
							<a href="<?php echo e(route('posts',$val->alias)); ?>" class="nobg a-circle"><img class="img-circle-custom" src="<?php if($val->image): ?><?php echo e(asset($val->image)); ?><?php else: ?><?php echo e(asset('assets/frontend/img/No_image_available.svg')); ?><?php endif; ?>" alt="<?php echo e(ucfirst($val->name)); ?>"></a>
							</div>
							<div class="entry-c">
							<div class="entry-title">
							<h4><a href="<?php echo e(route('posts',$val->alias)); ?>"><?php echo e(ucfirst($val->name)); ?></a></h4>
							</div>
							<!-- <ul class="entry-meta">
