...
============================================= -->
					<div id="shop" class="product-3 clearfix">
						...
						<div class="widget-heading ">
							<h2 class="widget-title" style="padding:5px 0">Kết quả tìm kiếm với từ khóa : " <?php echo e($key); ?> "</h2>							
						</div>
	...
	<script type="text/javascript" charset="UTF-8">
		function category_filter(e){
			var rs = 'tim-kiem/';
			if(e.value == ''){
				rs += '<?php echo $current_route->getParameter("key"); ?>';
			}else{
				rs += '<?php echo $current_route->getParameter("key"); ?>/' + e.value;
			}
