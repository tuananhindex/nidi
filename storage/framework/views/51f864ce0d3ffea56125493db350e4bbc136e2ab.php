                ...
                <div id="news_detail">
                    ...
                    <article class="n-details">
                        ...
                        <div class="datetime">
                            ...
                            <span id="dnn_ctr579_ctlNewsDetail_lblPublishedDate" class="date-info"><?php echo e(date('h:i d/m/Y',strtotime($index->create_at))); ?></span>
                            -
                            <span id="dnn_ctr579_ctlNewsDetail_lblReadCount">Số lần đọc</span>:
                            <span id="dnn_ctr579_ctlNewsDetail_lblPageView" class="date-info"><?php echo e($index->view); ?></span>
                        </div>
                        ...
                        <div class="n-topics">
                            <div>
                                ...
                                <div class="news_related">
                                    <?php foreach($same_posts as $val): ?>
                                    <div class="bg_related">
                                        <a class="link_related" href="<?php echo e(route('posts',$val->alias)); ?>">
                                        <?php echo e($val->name); ?></a><span class="datetime"> (<?php echo e(date('h:i d/m/Y',strtotime($index->create_at))); ?>)</span>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                                <?php else: ?>
