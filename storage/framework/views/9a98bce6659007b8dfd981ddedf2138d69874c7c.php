...
<div class="col830 fl">
    ...
    <div class="head_news"><a href="<?php echo e(route('posts.category',$val->alias)); ?>""><?php echo e(ucwords($val->name)); ?></a></div>
    <div class="pkg">
          <div class="col48per fl">
        <a href="<?php echo e(route('posts',$posts_top->alias)); ?>" ><img class="" src="<?php echo e(asset($posts_top->image)); ?>" width="343" height="220" alt="<?php echo e($posts_top->name); ?>" /></a>        <h2><a href="<?php echo e(route('posts',$posts_top->alias)); ?>" class="fontOPB f22" title="Phân biệt giới tính, đồng đội Rosicky bị đẩy xuống tập cùng đội nữ"><?php echo e($posts_top->name); ?></a></h2>        <div class="time_comment mar_top7 mar_bottom7">
      ...
      <?php
        ...
        <ul class="list_news_show_home">
            <?php foreach($posts as $val3): ?>
                      <li class="first pkg">
                <a href="<?php echo e(route('posts.category',$val3->alias)); ?>" class="thumbblock thumb140x90 fl" title="<?php echo e(ucfirst($val3->name)); ?>" ><img class="" src="<?php echo e(asset($val3->image)); ?>" width="140" height="90" alt="<?php echo e(ucfirst($val3->name)); ?>" /></a>                <h2><a href="http://www.bongda.com.vn/bayern-munich-se-khong-mua-coman-d362127.html" class="f18" title="<?php echo e(ucfirst($val3->name)); ?>"><?php echo e(ucfirst($val3->name)); ?></a></h2>                <div class="time_comment mar_top7 mar_bottom7">
                    <span><?php echo e(date('h:i d/m/Y',strtotime($posts_top->create_at))); ?>  </span>
                                    </div>
              </li>
            <?php endforeach; ?>         
