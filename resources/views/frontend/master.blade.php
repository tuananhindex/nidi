...
<html  lang="vi-VN">
    <head id="Head">
        ...
        <meta id="MetaDescription" name="description" content="@if(isset($description)){{ ucfirst($description) }}@endif" />
        <meta id="MetaKeywords" name="keywords" content="@if(isset($keywords)){{ $keywords }}@endif" />
        <meta id="MetaGenerator" name="GENERATOR" content="DotNetNuke " />
        <meta id="MetaRobots" name="ROBOTS" content="INDEX, FOLLOW" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="@if(isset($title)){{ ucfirst($title) }}@endif"/>
        <meta property="og:image" content="@if(isset($image)){{ asset($image) }}@endif"/>
        <meta property="og:site_name" content="David Walsh Blog"/>
        <meta property="og:description" content="@if(isset($description)){{ ucfirst($description) }}@endif" graph=" objects, allowing a certain level of customization over how information is carried over from a non-Facebook website to Facebook when a page is 'recommended', 'liked', or just generally shared."/>
        
        <link href="{{ asset('assets/frontend/css/default.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/ie.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/skin.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/container.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/portal.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/dnnStandardMenu.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/dnnMegaMenu.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/dnnMobileMenu.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/home.css') }}" type="text/css" rel="stylesheet"/>
        <link href="{{ asset('assets/frontend/css/NewsModule.css') }}" type="text/css" rel="stylesheet"/>
        <script src="{{ asset('assets/frontend/js/jquery.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/jquery-ui.js') }}" type="text/javascript"></script>     
        <link href="{{ asset('assets/frontend/lib/font-awesome-4.6.3/css/font-awesome.min.css') }}" type="text/css" rel="stylesheet"/>
        <link id="ProductHomeTab.css" href="{{ asset('assets/frontend/css/ProductHomeTab.css') }}" rel="stylesheet" type="text/css" />
        <script id="responsive-tabs.js" src="{{ asset('assets/frontend/js/responsive-tabs.js') }}" type="text/javascript"></script><script id="jssor.js" src="{{ asset('assets/frontend/js/jssor.js') }}" type="text/javascript"></script><script id="jssor.slider.js" src="{{ asset('assets/frontend/js/jssor.slider.js') }}" type="text/javascript"></script><script id="ProductHomeTab.js" src="{{ asset('assets/frontend/js/ProductHomeTab.js') }}" type="text/javascript"></script>
        <link id="ShoppingCart.css" href="{{ asset('assets/frontend/css/ShoppingCart.css') }}" rel="stylesheet" type="text/css" />
        <link id="Testimonial.css" href="{{ asset('assets/frontend/css/Testimonial.css') }}" rel="stylesheet" type="text/css" />
        <link id="ConferenceSideBar" href="{{ asset('assets/frontend/css/ConferenceSideBar.css') }}" rel="stylesheet" type="text/css" />
        <link id="GoogleSearch" href="{{ asset('assets/frontend/css/Documentation.css') }}" rel="stylesheet" type="text/css" />
        <link rel='SHORTCUT ICON' href="{{ asset('assets/frontend/img/favicon.gif') }}" type='image/x-icon' />
        <meta name="viewport" content="width=width=device-width, initial-scale=1" />
        <link href="{{ asset('assets/frontend/css/Telerik.Web.UI.WebResource.css') }}" type="text/css" rel="stylesheet" />
    ...
    <body id="Body">
            ...
            <script src="{{ asset('assets/frontend/js/WebResource.JS') }}" type="text/javascript"></script>
            <script type="text/javascript">
                //<![CDATA[
            ...
            <script src="{{ asset('assets/frontend/js/Telerik.Web.UI.WebResource.JS') }}" type="text/javascript"></script>
            <div class="aspNetHidden">
            ...
            <script src="{{ asset('assets/frontend/js/dnn.modalpopup.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/bootstrap.min.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/jquery.hoverIntent.min.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/dnnStandardMenu.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/dnnMegaMenu.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/dnnMobileMenu.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/jquery.nivo.slider.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/jquery.flexslider.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/unslider.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/lightbox-2.6.min.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/isotope.min.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/jquery.quovolver.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/jquery.visible.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/owl.carousel.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/jquery.scrolltofixed.min.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/jquery.fittext.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/custom.js') }}" type="text/javascript"></script><script src="{{ asset('assets/frontend/js/dnncore.js') }}" type="text/javascript"></script><script type="text/javascript">
                //<![CDATA[
            ...
            {!! App\Http\Controllers\frontend\BlockController::header_body() !!}
            @yield('content')
            {!! App\Http\Controllers\frontend\BlockController::footer() !!}
            <script type="text/javascript">
                $(".resize-text").fitText();
            </script>
        ...
        <div class="master-contact">
            ...
            <div class="box-contact-detail" style="display:none">
                ...
                <div class="content-cls">
                    ...
                    <p><span>Hotline</span> : 1900 636 083</p>
        ...
        <script type="text/javascript" src="{{ asset('assets/frontend/js/MISAContact.js') }}"></script>
    </body>
</html>