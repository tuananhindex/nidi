...
@section('content')
<link href="{{ asset('assets/frontend/css/NewsDetails.css') }}" type="text/css" rel="stylesheet" />
<link href="{{ asset('assets/frontend/css/PinNews.css') }}" type="text/css" rel="stylesheet" />
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-18 border-column">
                	{!! App\Http\Controllers\frontend\BlockController::detail_posts($index) !!}

                </div>
                <div class="col-md-6">
                    <div id="dnn_RowTwo3" class="ContentPadding">
                    	{!! App\Http\Controllers\frontend\BlockController::focus_posts() !!}
