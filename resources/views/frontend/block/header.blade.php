...
<div style="display:none">
 <a href="http://vesinhthanhpho.vn/bai-viet/gioi-thieu-ve-rut-ham-cau-trung-son" title="rut ham cau, dich vu rut ham cau, ham cau, rút hầm cầu, hầm cầu vesinhthanhpho.vn" rel="dofollow">rút hầm cầu</a>
</div>
	<div class="LogoRow">
		<div class="container">
			<div class="Logo">
				<a id="dnn_dnnLogo_hypLogo" title="Công ty cổ phần MISA" href="{{ route('home') }}"><img id="dnn_dnnLogo_imgLogo" src="{{ asset('assets/frontend/img/logo.gif') }}" alt="Công ty cổ phần MISA" /></a>
			</div>
			...
			<nav class="Nav">
				<img style="float: left; margin: 26px 63px" class="col-xs-12" src="{{ asset('assets/frontend/img/nidi.png') }}">
