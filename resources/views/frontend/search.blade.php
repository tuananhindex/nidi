...
@section('content')
<link href="{{ asset('assets/frontend/css/NewsByCategory.css') }}" type="text/css" rel="stylesheet" />
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                    $key = preg_quote($key);
                ?>
                	{!! preg_replace("/($key)/i","<strong style='color:#f00 !important'>$1</strong>",App\Http\Controllers\frontend\BlockController::search($key)) !!}

                </div>
                <div class="col-md-6">
                    <div id="dnn_RowTwo3" class="ContentPadding">
                    	{!! App\Http\Controllers\frontend\BlockController::customer_reviews() !!}
